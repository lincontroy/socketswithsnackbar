...
class PusherApp extends StatefulWidget {
  ...
  @override
  State<PusherApp> createState() => _MyAppState();
}

class _MyAppState extends State<PusherApp> {
  ...
  void onEvent(PusherEvent event) {
    //check the event and set the data controller

    var data = event.data;
    //check for the balance in the data
                        ...
                        Form(
                          ...
                          child: Column(children: <Widget>[
                            ListView.builder(
                                scrollDirection: Axis.vertical,
                                shrinkWrap: true,
                                itemCount: pusher.channels[_channelName.text]
                                    ?.members.length,
                                itemBuilder: (context, index) {
                                  final member = pusher
                                      .channels[_channelName.text]!
                                      .members
                                      .values
                                      .elementAt(index);
